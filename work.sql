...
INSERT INTO `STUDENT` VALUES('Ifetayo', 'Spencer', 'Computer Science', 1234);
INSERT INTO `STUDENT` VALUES('Khendra', 'Phillips', 'Biology ', 5678);
INSERT INTO `STUDENT` VALUES('Imaan', 'Adam', 'Computer Engineering', 3456);
INSERT INTO `STUDENT` VALUES('Wendy', 'Quay', 'Chemistry', 4590);
INSERT INTO `STUDENT` VALUES('Chunmei', 'Liu', 'Computer Engineering', 5337);
INSERT INTO `STUDENT` VALUES('Harry', 'Keeling', 'English', 5555);
...
(SELECT StudentID, CourseID, CategoryName, ASSIGNMENT.AssignmentID, Points, ASSIGNMENT.PointsPossible, DISTRIBUTION.Percentage
    ...
    WHERE DISTRIBUTION.DistributionID = ASSIGNMENT.DistributionID
    AND ASSIGNMENT.AssignmentID = SCORE.AssignmentID) pt
ON st.AssignmentID = pt.AssignmentID
AND st.CourseID = pt.CourseID; -- Removed st.StudentID condition
